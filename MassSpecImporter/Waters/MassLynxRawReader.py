...
class MassLynxRawReader(object):
    ...
    path = os.environ.get("MASSLYNX_RAW_DLL", os.path.join(pathtofile, "MassLynxRaw.dll"))
    ...
    try:
        ...
        raise OSError(
            "Unable to load the Waters MassLynx SDK. Set MASSLYNX_RAW_DLL to a "
            "locally licensed MassLynxRaw.dll."
        ) from error
