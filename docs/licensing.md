...
MassSpecImporter's Python code is BSD 3-Clause licensed. That license does not cover the
...
[`THERMO_RAWFILEREADER_TERMS.md`](https://github.com/michaelmarty/MassSpecImporter/blob/main/THERMO_RAWFILEREADER_TERMS.md)
and
[`THIRD_PARTY_NOTICES.md`](https://github.com/michaelmarty/MassSpecImporter/blob/main/THIRD_PARTY_NOTICES.md).
